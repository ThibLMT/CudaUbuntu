/**
 *\file read_micro.c
 *\brief body of the function read_micro
 */

#include "read_micro.h"

/**
*\fn int get_line_microfile_line(const char *Nmicrofile)
*\brief get the number of particles described in microfile
*\param *Nmicrofile name of the readed microstructure file
*\return int 
**/
